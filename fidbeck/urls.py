...
urlpatterns = [
    ...
    path('view/<int:pk>', Fidbecdetaileview.as_view(), name='view'),
    path('edit/<int:pk>', Fidbecupdateview.as_view(), name='edit'),
    path('delete/<int:pk>', FidbecdeleteView.as_view(), name='delete'),
